...
const EpopeePage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans antialiased">
      {/* --- HERO SECTION --- */}
      <section className="relative h-[70vh] min-h-105 md:h-150 flex items-center justify-center overflow-hidden bg-[#0a192f]">
		...
		font-black text-white mb-6 leading-tight tracking-tighter"
          ...
          <p
            className="text-base sm:text-lg md:text-xl text-blue-50
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            <div className="lg:col-span-8 p-8 md:p-16">
              ...
              <div className="space-y-6 text-lg text-slate-600 leading-relaxed">
                ...
                <p>
                  En parfait alignement avec la stratégie nationale, notre
                  ambition est de bâtir un capital humain fort et résilient.
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {gallery.map((img) => (
              ...
              >
                ...
                />
                <div className="absolute inset-0 bg-linear-to-t from-slate-900 via-slate-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-end p-10">
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {filieres.map((f) => (
                  <div
                    key={f.name}
                    className={`group bg-white p-7 rounded-4xl border-b-4 ${f.accent} hover:-translate-y-2 transition-all duration-300 flex flex-col h-full`}
                  >
                    <div
                    ...
                    <div className="mt-auto flex items-center justify-between pt-4 border-t border-slate-50">
                      ...
                      <ChevronRight
                        className="text-[#28a745] opacity-0 group-hover:opacity-100 -translate-x-2.5 group-hover:translate-x-0 transition-all"
                        size={16}
                      />
                    </div>
                  </div>
        ...
        <section className="text-center bg-white p-16 md:p-20 rounded-[5rem] shadow-2xl border border-slate-100 relative overflow-hidden">
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <Link
                to="/contact"
                className="flex items-center justify-center bg-[#28a745] text-white font-black py-4 px-6 rounded-4xl shadow-xl hover:-translate-y-2 transition-all duration-300 text-lg"
              >
                Nous Contacter{" "}
          ...
          <div className="absolute top-0 right-0 w-125 h-125 bg-emerald-50 rounded-full blur-[120px] -mr-64 -mt-64 opacity-50" />
        </section>
      </div>
    </div>
  );
