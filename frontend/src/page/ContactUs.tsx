        ...
        <div className="flex flex-col gap-6">
          <div className="space-y-1">
            ...
            <h1 className="text-5xl md:text-8xl font-black tracking-tighter text-slate-900 leading-none">
              Contactez-nous<span className="text-green-600">...</span>
            </h1>
          </div>
            ...
            <div className="max-w-6xl mx-auto px-4">
              ...
              <div className="text-center mb-12">
                <h2 className="text-4xl md:text-6xl font-black text-slate-900">
                  Devenez Bénévole<span className="text-green-600">...</span>
                </h2>
                <p className="text-slate-500 mt-4 max-w-xl mx-auto">
                  Engagez-vous à nos côtés et participez activement à nos
                  actions solidaires.
                </p>
              </div>
