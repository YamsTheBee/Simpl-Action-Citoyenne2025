    ...
    return (
      <div className="mx-auto max-w-3xl px_8 text-center py-12 bg-white rounded-[3rem] border border-slate-100 shadow-sm">
        ...
        <p className="text-slate-500 mb-8 max-w-md mx-auto">
          Votre contribution directe permet de financer nos projets d'éducation
          et d'accès à l'eau.
        </p>
        <button
            ...
            <div className="text-center mb-6">
              ...
              <div className="flex justify-center gap-4 mt-6">
                <button
                  ...
                  className={`flex-1 p-3 rounded-xl border-2 flex flex-col items-center gap-1 ${method === "local" ? "border-green-600 bg-green-50" : "border-slate-100"}`}
                >
                  <Smartphone size={20} />{" "}
                ...
                <button
                  ...
                  className={`flex-1 p-3 rounded-xl border-2 flex flex-col items-center gap-1 ${method === "intl" ? "border-green-600 bg-green-50" : "border-slate-100"}`}
                >
                  <Globe size={20} />{" "}
                  <span className="text-[10px] font-bold uppercase">
                    Carte Bancaire
              ...
              <div className="grid grid-cols-4 gap-2">
                {[1000, 2000, 5000, 10000].map((val) => (
                  <button
                    ...
                    className={`py-2 text-xs font-bold rounded-lg ${amount === val ? "bg-green-600 text-white" : "bg-slate-50 text-slate-500"}`}
                  >
                    {val}
                  </button>
                ))}
...
const PARTNERS_INFINITE = [
  ...
  { name: "FondationSonatel", logoUrl: logoFondationSonatel, height: "h-24" },
  ...
  return (
    ...
    >
      ...
      <div className=" min-h-full flex /* MOBILE : alignement en haut */  items-start md:items-center justify-center p-4 ">
        {/*  CARD */}
        <div className="bg-white w-full max-w-2xl rounded-2xl md:rounded-[3rem] shadow-2xl relative /* Padding responsive */ p-6 md:p-10 animate-in fade-in zoom-in duration-300">
          ...
          <div className="text-slate-600 space-y-5 relative z-10 leading-relaxed text-lg italic">
            <p>
              ...
              <strong> Simple Action Citoyenne (SAC)</strong> après avoir
              constaté les réalités poignantes des{" "}
              <strong>zones reculées</strong>.
            </p>

            <p>
              Son engagement est né du constat des difficultés rencontrées par
              les populations des zones reculées, notamment
              <strong> l’accès limité à l’eau potable</strong>.
            </p>

            <p>
              Très tôt confronté aux réalités du terrain, il fonde l’association
              <strong> Simple Action Citoyenne</strong> avec la volonté
              d’apporter des
            ...
            <p>
              ...
              idéal : améliorer durablement les{" "}
              <strong>conditions de vie</strong>, favoriser l’accès à{" "}
              <strong>l’éducation</strong> et à<strong> l’eau potable</strong>,
              et renforcer la
            ...
            <p>
              ...
              <strong>développement social et économique</strong> des
            ...
            <p>
              ...
              <strong> numérique</strong>, tout en restant fidèle à la devise
              qui guide son engagement :
...
const AboutPage = () => {
  ...
  useEffect(() => {
    ...
    const speed = window.innerWidth < 768 ? 0.08 : 0.04;
    // mobile plus rapide
    ...
    const animate = (time: number) => {
      ...
      setPartnersOffset((prev) => {
        ...
        // reset quand moitié parcourue (car liste doublée)
        const resetPoint = document.body.clientWidth;
        if (next >= resetPoint) return 0;
                ...
                {LOOPED_PARTNERS.map((p, idx) => (
                  ...
                  >
                    <img
                      src={p.logoUrl}
                      alt={p.name}
                      className={`${p.height} object-contain opacity-80 hover:opacity-100 transition-all duration-300`}
                    />
                  </div>
                ))}
              </div>
